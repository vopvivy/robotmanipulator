...
bluetooth.onBluetoothConnected(function () {
    ...
    while (connect_flag == 1) {
        ...
        if (ble_val == "a") {
            ...
            speed_LF_value = Math.trunc(Math.map(speed_LF, 0, 100, 0, 255))
            basic.pause(100)
            ...
            speed_LB_value = Math.trunc(Math.map(speed_LB, 0, 100, 0, 255))
            basic.pause(100)
            ...
            speed_RF_value = Math.trunc(Math.map(speed_RF, 0, 100, 0, 255))
            basic.pause(100)
            ...
            speed_RB_value = Math.trunc(Math.map(speed_RB, 0, 100, 0, 255))
            basic.pause(100)
